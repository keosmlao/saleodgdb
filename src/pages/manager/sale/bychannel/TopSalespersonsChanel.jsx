...
export default function TopSalespersonsChanel({ bu , department }) {
  ...
  return (
    <div className="bg-white p-3 text-black rounded-2xl shadow-sm  font-[Noto_Sans_Lao]">
      <h5 className="font-bold mb-3 text-[15px] font-[Noto_Sans_Lao]">🏆10 ອັນດັບພະນັກງານຂາຍຍອດນິຍົມ</h5>
      <div className="flex flex-wrap gap-2 items-center  mb-3 text-[12px] font-[Noto_Sans_Lao]">
